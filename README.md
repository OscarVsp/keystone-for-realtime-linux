...
- Updated Linux kernel version (from 6.1 to 6.6) to have acces to the PREEMPT_RT patches for RISC-V (available as standalone).
- New build target for RT variant which add the PREEMPT_RT patches and Linux kernel configuration.
...
If you want to build the image yourself to make some change, you will have some requirement for yourt system. Please refer to [docs/building.md](docs/building.md) in that case.
