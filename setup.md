...
The `mouse-grab` keystrokes are `Ctrl-a` cna be used to acces the following qemu commands:

- `Ctrl-a h`: help menu
- `Ctrl-a x`: quit qemu
- `Ctrl-a s`: save disk data to file
- `Ctrl-a t`: toggle console timestamps
- `Ctrl-a b`: send break
- `Ctrl-a c`: switch between console / monitor
